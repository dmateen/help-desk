  ...
  const onSubmit = async (data) => {
    try {
      ...
      if (response?.status === 200) {
        ...
        isPatient ? router.push("/prescriptions") : router.push("/dashboard");
      }
    } catch (e) {
      console.log(e);
    }
  ...
  return (
    <Form {...form}>
      <form
        ...
        className="w-full lg:grid lg:min-h-[600px] lg:grid-cols-2 xl:h-lvh"
      >
        <div>
          <div className="p-12">
            <ThemeSwitcher />
          ...
          <div className="flex items-center justify-center py-12">
            <div className="mx-auto grid w-[350px] gap-6">
              ...
              <div className="grid gap-4">
                ...
                <Button
                  onClick={() => setIsPatient((prev) => !prev)}
                  variant="outline"
                  className="w-full"
                >
